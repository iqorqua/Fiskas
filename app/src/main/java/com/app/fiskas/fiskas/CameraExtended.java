...
public class CameraExtended {
     ...
     */
    private CameraExtended(Builder builder) {
    ...
    public void takePicture() throws NullPointerException, IllegalAccessException {
        ...
        takePictureIntent.setFlags(Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY);
        switch (mode) {
            case ACTIVITY:
    ...
    public static class Builder {
        ...
        public Builder() {
            dirName = CameraExtended.IMAGE_DEFAULT_DIR;
            imageName = CameraExtended.IMAGE_DEFAULT_NAME + System.currentTimeMillis();
            imageHeight = CameraExtended.IMAGE_HEIGHT;
            compression = CameraExtended.IMAGE_COMPRESSION;
            imageType = CameraExtended.IMAGE_FORMAT_JPG;
            REQUEST_TAKE_PHOTO = CameraExtended.REQUEST_TAKE_PHOTO;
        }
        ...
        public CameraExtended build(Activity activity) {
            this.activity = activity;
            context = activity.getApplicationContext();
            mode = MODE.ACTIVITY;
            return new CameraExtended(this);
        }

        public CameraExtended build(Fragment fragment) {
        ...
        public CameraExtended build(android.support.v4.app.Fragment fragment) {
